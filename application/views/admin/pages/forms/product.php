                                    ...
                                    <div class="col-md-8">
                                        <div class="row col mt-3">
                                            ...
                                            <div class="col-md-4">
                                               ...
                                               <div class="col-md-4">
                                                       <label for="sold_by" class="col-form-label">Sold By </label>
                                                        <input type="text" class="col-md-12 form-control" name="sold_by" value="<?= (isset($product_details[0]['sold_by'])) ? $product_details[0]['sold_by'] : ''; ?>" placeholder='Sold By'>
                                                                          </div>
                                                                           <div class="col-md-4">
                                                                                                                                 <label for="pur_price" class="col-form-label">Purchase Price </label>
                                                                                                                                  <input type="text" class="col-md-12 form-control" name="pur_price" value="<?= (isset($product_details[0]['pur_price'])) ? $product_details[0]['pur_price'] : ''; ?>" placeholder='Purchase Price'>
                                                                                                                                                    </div>
                                            <div class="col-md-4">
