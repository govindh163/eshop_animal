        ...
        <div class="row mb-5">
            ...
            <div class="col-md-8 col-12">
                <div class='card border-0'>
                    ...
                    <form action="<?= base_url('my-account/add-enquiry') ?>" method="POST" id="add-enquiry-form" class="mt-4 p-4">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                              ...
                              <div class="col-md-2 col-xs-6">
                                          <label for="is_default" class="col-form-label">Set As Default?</label>
                                           <input type="checkbox" name="is_default" <?= (isset($product_details[0]['cod_allowed']) && $product_details[0]['cod_allowed'] == '1') ? 'Checked' : '' ?> data-bootstrap-switch data-off-color="danger" data-on-color="success">
                                                   </div>
                ...
                <form action="<?= base_url('my-account/edit-address') ?>" method="POST" id="edit-address-form" class="mt-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                            ...
                            <input type="text" class="form-control" id="edit_pincode" name="pincode" placeholder="Name" />
                        </div>
                        <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                            <label for="state" class="control-label"><?=!empty($this->lang->line('state')) ? $this->lang->line('state') : 'State'?></label>
